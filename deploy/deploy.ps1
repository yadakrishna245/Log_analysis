...
.DESCRIPTION
    ...
    Features: 675 Patterns | 120 known issues | 14 categories | Jira RCA | Local AI | Intelligence Layer | 172 Features
.PARAMETER StackName
...
Write-Host "  ║   675 Patterns | 172 Features | Enterprise       ║" -ForegroundColor Cyan
