...
.DESCRIPTION
    ...
    Features: 455 patterns | 120 known issues | 14 categories | Jira RCA | Local AI | Intelligence Layer | 137 Features
.PARAMETER StackName
...
Write-Host "  ║   455 Patterns | 137 Features | Enterprise       ║" -ForegroundColor Cyan
